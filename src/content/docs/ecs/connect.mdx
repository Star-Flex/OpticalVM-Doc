...
2. 默认情况下云服务器 RDP 远程连接按钮是灰色的，这是因为没有开放对应的端口号。
   ...
   ![windows-step2](../../../assets/connect/windows-step2.webp)

3. 在弹出的模态框中，选择 **Windows 远程桌面 (3389)** ，然后点击 **确认** 映射端口

   ![windows-step3](../../../assets/connect/windows-step3.webp)

4. 端口映射成功后，RDP 远程连接按钮会变为蓝色，点击该按钮即可下载远程桌面连接文件（.rdp）。双击打开该文件，输入 **服务器** 密码，即可连接到您的 Windows 服务器。

   ![windows-step4](../../../assets/connect/windows-step4.webp)
   ...
   ![windows-step5](../../../assets/connect/windows-step5.webp)
   ...
   ![windows-step6](../../../assets/connect/windows-step6.webp)
...
2. 默认情况下云服务器 SSH 远程连接按钮是灰色的，这是因为没有开放对应的端口号。
   ...
   ![linux-1](../../../assets/connect/linux-1.webp)

3. 在弹出的模态框中，选择 **Linux 远程 SSH (22)** ，然后点击 **确认** 映射端口

   ![linux-2](../../../assets/connect/linux-2.webp)
...
1. 点击控制台右上角的 **SSH 远程连接** 按钮，弹出连接信息模态框，复制下方的连接命令
   ...
   ![linux-3](../../../assets/connect/linux-3.webp)

2. 粘贴到您的终端（Terminal）中，按回车执行该命令。

   ![linux-5](../../../assets/connect/linux-5.webp)
...
1. 点击 Tabby 的 **新建连接** 按钮，选择 **SSH** 连接类型。或直接点击新建窗口，教程以后者为主。
   ...
   ![linux-6](../../../assets/connect/linux-6.webp)

2. 从原光云控制台点击防火墙按钮，复制内网 `22` 端口对应的公网连接 IP 地址

   ![linux-4](../../../assets/connect/linux-4.webp)

3. 粘贴进 Tabby 的输入框中，并同意 host key，点击连接按钮。

   ![linux-7](../../../assets/connect/linux-7.webp)

4. 连接成功

   ![linux-8](../../../assets/connect/linux-8.webp)
...
2. 点击 Xshell 的 **新建连接** 按钮，选择 **SSH** 连接类型。名称可以随意填写。主机填写刚才复制的 IP 地址，端口填写 `:` 号后面显示的数字 ，协议选择 `SSH`，点击确定保存。
   ...
   ![linux-9](../../../assets/connect/linux-9.webp)

3. 连接成功

   ![linux-10](../../../assets/connect/linux-10.webp)
